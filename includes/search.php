...
*/
    ...
    $data[ 'page' ][ 'title' ] = 'Search Results';
    
    // strip non-word non-whitespace chars from query
    $qry = ( isset( $_POST[ 'qry' ] ) ? preg_replace( "/[^\w\s]/", "", $_POST[ 'qry' ] ) : '' );
    
    if( $qry ) {
        
        $data[ 'page' ][ 'query' ] = $qry;
        
        $results = $wiki->getSearchResults( $qry, 20 );
